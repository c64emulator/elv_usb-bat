...
make install
#modules:
root@emil-neu:/usr/local/sbin# cp ../src/LCDproc/lcdproc-0.5.7/server/drivers/glcd.so .
root@emil-neu:/usr/local/sbin# cp ../src/LCDproc/lcdproc-0.5.7/server/drivers/glcd-glcd-usbbat.o .
# initscripts:
